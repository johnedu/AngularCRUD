namespace AngularCRUD.Classify
{
    ...
    public class ClassifyService : IClassifyService
    {
        ...
        {
            this._superPowersPersonRepository = superPowersPersonRepository;
        }
        ...
        public GetClassifyHeroesAndVillainsOutput GetClassifyHeroesAndVillains(GetClassifyHeroesAndVillainsInput listSuperPowersPersons)
        {
            ...
            try
            {
                ...
                this._superPowersPersonRepository.Delete(s => s.TenantId == 0);
                foreach (string heroeOrVillain in listSuperPowersPersons.ListHeroesAndVillains)
                {
                    if (heroeOrVillain.Contains(AngularCRUDConsts.VillainLetter))
                    {
                        ...
                        heroOrVillainId = this._superPowersPersonRepository.InsertAndGetId(superPowersPerson);
        ...
        public GetAllSuperHeroesOutput GetAllSuperHeroes()
        {
            ...
            try
            {
                ...
                var listSuperHeroes = this._superPowersPersonRepository.GetAll().Where(person => person.Type == AngularCRUDConsts.SuperHeroType).ToList();
